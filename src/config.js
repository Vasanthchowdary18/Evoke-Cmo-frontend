...
export const WEBHOOK_URL = import.meta.env.DEV
  ...
  : 'https://vasanthchowadry373.app.n8n.cloud/webhook/evoke-cmo';
...
export const DAY_WEBHOOK_URL = import.meta.env.DEV
  ...
  : 'https://vasanthchowadry373.app.n8n.cloud/webhook/evoke-cmo-day';
...
export const AGENT_WEBHOOK_URL = import.meta.env.DEV
  ...
  : 'https://vasanthchowadry373.app.n8n.cloud/webhook/evoke-agents';
...
export const GOOGLE_ADS_OAUTH_WEBHOOK    = 'https://vasanthchowadry373.app.n8n.cloud/webhook/google-ads-oauth';
export const GOOGLE_ADS_CREATE_WEBHOOK   = 'https://vasanthchowadry373.app.n8n.cloud/webhook/google-ads-create-campaign';
export const GOOGLE_ADS_METRICS_WEBHOOK  = 'https://vasanthchowadry373.app.n8n.cloud/webhook/google-ads-metrics';
