...
const HUB_CONFIG = {
  ...
  content: {
    ...
    tools: [
      ...
      { label: 'Reel Scripts', badge: 'SCRIPTS', desc: 'Hook, body, and CTA scripts for short-form videos — Reels, TikTok, and YouTube Shorts.', icon: <FileText size={20}/>, color: '#f59e0b', route: '/reel-scripts' },
      { label: 'SEO & Blog Post', badge: 'SEO', desc: 'Full 1,500-word SEO-optimised blog with meta tags, keywords, and internal links.', icon: <Search size={20}/>, color: '#06b6d4', route: '/campaign/seo_blog' },
      ...
      { label: 'Influencer & PR Brief', badge: 'PR', desc: 'Influencer campaign brief, press release, and media pitch templates.', icon: <Megaphone size={20}/>, color: '#ec4899', route: '/campaign/influencer' },
    ],
  },
